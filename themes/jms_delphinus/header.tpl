	...
	{if !isset($content_only) || !$content_only}
		...
		<div id="page" class="clearfix">
			...
			<section class="container page-content">
				<div class="row">
					{if $page_name!='index' && $page_name!='product' && $page_name!='contact' && !$hide_left_column && !empty($HOOK_LEFT_COLUMN)}
					...
					{if $page_name!='index'}
						...
						{elseif  ($page_name == 'contact')}
							<section class="col-sm-12 col-md-12 col-lg-12" id="center_column">
