...
{if $errors|@count == 0}
	...
	<div class="row" itemscope itemtype="http://schema.org/Product">
		...
		<div class="pb-right-column col-sm-6 col-md-6 col-lg-6">
			...
			<h1 itemprop="name" style="color: #000;">{$product->name|escape:'html':'UTF-8'}</h1>
							...
							<div id="attributes" class="row">									
								{foreach from=$groups key=id_attribute_group item=group}
									{if $group.attributes|@count}
										<fieldset class="attribute_fieldset col-md-3">
			...
			<div id="more_info_block">		
				<div class="tabs-info">
					<ul class="nav nav-tabs">
						{if $product->description}<li class="active"><a href="#tabs-1" data-toggle="tab">{l s='Description'}</a></li>
						{else}				
						{if isset($features) && $features}
						<li class="active"><a href="#tabs-2" data-toggle="tab">{l s='Specification'}</a></li>
						{/if}
						{/if}
